...
import com.lixinxinlove.all.util.AppBarStateChangeListener
...
class CoordinatorActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toolbar: Toolbar = findViewById(R.id.tb_amd_toolbar)
       ...
       // setSupportActionBar(toolbar)
        ...
        appBarLayout.addOnOffsetChangedListener(object : AppBarStateChangeListener() {
            override fun onOffsetChanged(appBarLayout: AppBarLayout?) {
               // Log.e("CoordinatorActivity", "onOffsetChanged")
            }

            override fun onStateChanged(appBarLayout: AppBarLayout?, state: State?) {
                Log.e("CoordinatorActivity", state!!.name)
            }
        })

        val iv: ImageView = this.findViewById(R.id.iv_movie_icon)
