...
import com.daasuu.imagetovideoandroid.ImageLoadListener
import com.daasuu.imagetovideoandroid.ImageLoader
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        when (requestCode) {
            PERMISSION_REQUEST_CODE -> if (grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(this@ImageToVideoActivity, "permission has been grunted.", Toast.LENGTH_SHORT)
                    .show()
            } else {
                Toast.makeText(this@ImageToVideoActivity, "[WARN] permission is not grunted.", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
